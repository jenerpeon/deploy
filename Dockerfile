...
# INSTALL
RUN apt-get install -y --force-yes libparse-debcontrol-perl vim-nox emacs24-nox ca-certificates sudo locales devscripts build-essential git tcos-dev zsh fish openssh-client
